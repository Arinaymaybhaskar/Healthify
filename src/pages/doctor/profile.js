        ...
        <div className="profile-container">
          ...
          <div className="profile-details">
            ...
            <div className='edit-profile-form'>
              ...
              <div className="input">
                <input type="text" className="input-field" required />
                <label class="input-label">Qualifications</label>
              </div>
              <div className="input">
                <input type="text" className="input-field" required />
              ...
              <div className="input">
                <label class="input-label">Social accounts <AiOutlineLink /></label>
              </div>

              <div className="input">
                <input type="url" className="input-field" required />
                <label class="input-label-social"><AiFillYoutube/></label>
              </div>
              <div className="input">
                <input type="url" className="input-field" required />
                <label class="input-label-social"><AiFillLinkedin/></label>
              </div>
              <div className="input">
                <input type="url" className="input-field" required />
                <label class="input-label-social"><AiOutlineTwitter/></label>
              </div>
